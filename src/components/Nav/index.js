      ...
      <section className="left" id="home">
        <article className="card linksLeft links" href="#experience">
          <a href="#experience">
            <img
              className="card-img"
              src={require("../../assets/images/boardroom.jpg")}
              alt="conference room"
            />
          </a>
          <div className="title">
        ...
        <article className="card linksLeft links" href="#education">
          <a href="#education">
            <img
              className="card-img"
              src={require("../../assets/images/floatingBook.jpg")}
      ...
      <section className="middle">
        <article>
          ...
          <p>
            ...
            technology as a full stack Web Developer and aspires to use her
            previous experience to build unique tools that support everyday life
      ...
      <section className="right" id="right">
        ...
        <article className="card linksRight links" href="#contact">
          <a href="#contact">
            <img
              className="card-img"
              src={require("../../assets/images/wooddesk.jpg")}
              alt="cellphone on desk"
            />
          </a>
          <div className="title">
            <p>Contact</p>
